...
function daily_createCardBody(icon, description, maxTemp, minTemp) {
  return createElement({
    attributes: {
      class: 'card-body',
    },
...
function daily_createCard(dayData) {
  return createElement({
    tagName: 'article',
    attributes: {
      class: 'card card-day',
  ...
  return createElement({
    ...
    children: [
      ...
      createElement({
        ...
        children: dailyData.map(daily_createCard),
      }),
    ],
  });
}
...
async function displayWeather({ cityName = null }) {
  ...
  render(today(locationData, weatherData.current), mainContainer);
  render(daily(weatherData.daily), mainContainer);
