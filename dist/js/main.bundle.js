...
;// CONCATENATED MODULE: ./src/js/api/util.js
...
/* harmony default export */ const util = (makeRequest);

;// CONCATENATED MODULE: ./src/js/api/openweathermap.js
...
;// CONCATENATED MODULE: ./src/js/dom/util.js
...
;// CONCATENATED MODULE: ./src/js/dom/today.js
...
/* harmony default export */ const today = (createTodaySection);

;// CONCATENATED MODULE: ./src/js/dom/daily.js



function daily_createCardFooter(description) {
  return createElement({
    tagName: 'footer',
    content: description,
  });
...
function daily_createCardBody(icon, description, maxTemp, minTemp, units) {
  return createElement({
    attributes: {
      class: 'card-body',
    },
...
function daily_createCardHeader(dt) {
  return createElement({
    tagName: 'header',
    attributes: {
      class: 'card-header',
...
function daily_createCard(dayData, units) {
  return createElement({
    tagName: 'article',
    attributes: {
      class: 'card card-day',
    ...
    children: [
      daily_createCardHeader(dayData.dt),
      daily_createCardBody(
      ...
      daily_createCardFooter(dayData.weather.description),
    ],
  });
}
  ...
  return createElement({
    ...
    children: [
      ...
      createElement({
        ...
        children: dailyData.map((day) => daily_createCard(day, units)),
      }),
    ],
  });
}

/* harmony default export */ const daily = (createDailySection);

;// CONCATENATED MODULE: ./src/js/dom/credit.js
...
/* harmony default export */ const credit = (createBackgroundCredit);

;// CONCATENATED MODULE: ./src/js/api/unsplash.js
...
/* harmony default export */ const unsplash = (getImage);

;// CONCATENATED MODULE: ./src/js/dom/weather.js
...
async function displayWeather({ cityName = null, units = 'metric' }) {
  ...
  render(
    today(locationData, weatherData.current, weatherData.units),
    mainContainer
  );
  render(
    daily(weatherData.daily, weatherData.units),
    mainContainer
  );
  ...
  const imageData = await unsplash(imageDescription);
...
/* harmony default export */ const weather = (displayWeather);
...
document.addEventListener('DOMContentLoaded', () => {
  ...
  searchForm.addEventListener('submit', async (event) => {
    ...
    weather({ cityName: cityName.value });
  });
  weather({});
});
